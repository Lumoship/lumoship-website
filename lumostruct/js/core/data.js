        ...
        //
        // DIS KAYNAKLA DOGRULAMA (22 Eylul 2026) - BV MARS2000 kurulumundaki
        //   profil tablolari: C:\BVeritas\Mars2000\Buldin.dat (DIN, 62 olcu),
        //   Bulbbs.dat (BS, 59), Bulafn.dat (AFNOR, 38), Buljis.dat (JIS, 4).
        //   Bu tablo bizim turetmemizden BAGIMSIZ: baska bir kurum, baska bir
        //   program, 1990'lardan kalma bir veri dosyasi.
        //
        //   BS ve DIN tablolariyla eslesen 57-58 olcude: alan farki en fazla
        //   %0,6, dx %1,1, atalet %2,2. Yani 14 Eylul duzeltmesi DOGRUYDU -
        //   eski katalogla fark %13-27 olurdu.
        //
        //   AFNOR tablosu SISTEMATIK %4-6,5 buyuk cikiyor (alan, dx, atalet
        //   hepsi). Bu bir hata degil: AFNOR boudin profili baska bir kesit
        //   ailesi. Cizim "AFNOR" diyorsa bu katalog %5 kucuk kalir.
        //
        // HP60 ailesi EN 10067'de YOK (en kucuk EN olcusu HP80x5) ve tek
        //   kaynakliydi; dx / Ixx sutunlari YANLISTI. Uc bagimsiz kaynak ayni
        //   yeri gosterdi:
        //     MARS2000 DIN            dx 3,82 / 3,70   (bizde 3,48 / 3,41)
        //     BV NR467 esdeger kesit  dx 3,79 / 3,70   (js/core/profiles.js)
        //     DNV 3D Beam profil penceresi: HP60x4 + 600x8'de Iy %8 sapiyordu
        //       (tests/verify-dnv-profil.js, "DNV'nin geometrisi farkli" diye
        //       aciklanmisti - aciklama yanlismis)
        //   Elle kontrol de ayni: govde 2,4 cm2 merkezi 3,0 cm, bulb 1,18 cm2
        //   merkezi ~5,3 cm -> dx = 3,76 cm. 3,48 icin bulb merkezinin 4,46
        //   cm'de, yani ucundan 1,5 cm asagida olmasi gerekirdi.
        //   Artik: dx 3,82 / 3,70 / 3,61, Ixx 12,2 / 14,4 / 16,46.
        //
        // MARS tablolarinda olup bizde olmayan 6 olcu eklendi (HP60x6,
        //   HP140x6.5, HP300x14, HP320x15, HP400x17, HP430x21). Degerler
        //   MARS'tan KOPYALANMADI: komsu satirdan artis yasasiyla turetildi ve
        //   MARS ile karsilastirildi (fark: A %0,3, dx %0,7, Ixx %0,4 altinda).
        //   Boylece katalog kendi icinde TAM tutarli kalir - iki tabloyu
        //   karistirmak artis yasasi testini 0,05-0,11 cm ihlal ediyordu.
        //
        //   DERS (yine): artis yasasi testi bu hatayi YAKALAYAMAZ - iki satir
        //   kendi aralarinda tutarliydi. Ic tutarlilik dogruluk degildir.
        //
        // Dogrulama: tests/verify-hp-katalog.js
        const HP_CATALOG = [
// >>> HP_KATALOG - TEK KAYNAK: Apps/_standart/hp-katalog.json (hp-yay.py yazar, elle duzenleme)
            { name: "HP60x4", b: 60, t: 4, c: 13, r: 3.5, A: 3.58, dx: 3.82, Ixx: 12.2 },   // dx/Ixx 22 Eyl 2026'da duzeltildi, bkz. HP60 notu
            { name: "HP60x5", b: 60, t: 5, c: 13, r: 3.5, A: 4.18, dx: 3.7, Ixx: 14.4 },
            { name: "HP60x6", b: 60, t: 6, c: 13, r: 3.5, A: 4.78, dx: 3.61, Ixx: 16.46 },   // MARS DIN 4,78/3,62/16,4 ile %0,3 icinde; satir komsusundan artis yasasiyla
            ...
            { name: "HP80x8", b: 80, t: 8, c: 14, r: 4, A: 7.81, dx: 4.66, Ixx: 47.7 },   // MARS/EN tablolarinda yok; HP80x7 satirindan artis yasasiyla (Midship cizim listesinde vardi)
            ...
            { name: "HP140x6.5", b: 140, t: 6.5, c: 19, r: 5.5, A: 11.73, dx: 8.43, Ixx: 228 },   // MARS BS 11,70/8,37/228
            ...
            { name: "HP300x14", b: 300, t: 14, c: 43, r: 13, A: 55.79, dx: 18.27, Ixx: 4966 },   // MARS DIN 55,8/18,3/4980
            ...
            { name: "HP320x15", b: 320, t: 15, c: 46, r: 14, A: 63.84, dx: 19.51, Ixx: 6452 },   // MARS DIN 63,9/19,5/6480
            ...
            { name: "HP400x17", b: 400, t: 17, c: 58, r: 18, A: 93.43, dx: 24.81, Ixx: 14791 },   // MARS DIN 93,4/24,7/14850
            ...
            { name: "HP430x21", b: 430, t: 21, c: 62.5, r: 19.5, A: 119.97, dx: 26.18, Ixx: 21884 },   // MARS DIN 120/26,1/21950
// <<< HP_KATALOG
        ];

        // ---- BULB PROFIL AILESI ----------------------------------------
        // Ayni "HP 200x10" adi her ulkenin tablosunda AYNI kesit demek degil:
        // olculdu (22 Eylul 2026, BV MARS2000 tablolari) - AFNOR ailesi ayni
        // olcude alanda %4-6,5, atalette %3,6-6,5 BUYUK. Cizim AFNOR diyorsa
        // EN tablosuyla hesaplamak kesidi sistematik olarak kucuk gosterir.
        //
        // Aileler AYRI listelerde durur ve kullanici secer; HP_CATALOG "aktif
        // aile"dir. Tek listede birlestirmek, aramanin hangi satiri once
        // buldugunu belirleyici yapardi - sessiz hata.
        ...
        // EN listesinin degismeyen kopyasi (aile degistirip geri donebilmek icin)
        ...
        // Aileyi degistirir: HP_CATALOG'un ICERIGI degisir, boylece butun
        // okuyucular (profiles.js, sections.js, import.js, tabs.js) tek satir
        // degisiklik olmadan yeni aileyi gorur.
        function hpAilesiSec(kod) {
            ...
            HP_AKTIF_AILE = kod;
            if (typeof updateProfilesTable === 'function') { try { updateProfilesTable(); } catch (e) { } }
            if (typeof updateSectionDropdowns === 'function') { try { updateSectionDropdowns(); } catch (e) { } }
            return true;
        }
