...
window.CF_CONFIG = {
  ...
  semantic: 'browser',
  noStore: false,
  dataVersion: '20260917b'  // LR SSC inline formulas read, 64 figures with non-ASCII names now served (20260917a: BV NR615 buckling; (20260916c: LR Materials, BV NR467 Parts A-F, DNV class guidelines). Bump when a book is added: browsers cache
